...
ALTER TABLE `Cards` ADD FOREIGN KEY (`FK_element`) REFERENCES `Elements` (`id_name`);
...
CREATE TABLE IF NOT EXISTS `Cards_Deck` (
  `Cards_PK_id` integer,
  `Deck_PK_FK_card` integer,
  PRIMARY KEY (`Cards_PK_id`, `Deck_PK_FK_card`),
  FOREIGN KEY (`Cards_PK_id`) REFERENCES `Cards` (`PK_id`)
);

ALTER TABLE `Cards_Deck` ADD FOREIGN KEY (`Cards_PK_id`) REFERENCES `Cards` (`PK_id`);

ALTER TABLE `Cards_Deck` ADD FOREIGN KEY (`Deck_PK_FK_card`) REFERENCES `Deck` (`PK_FK_card`);
